...
/**
 * Created by hongoyuka on 2018/01/21.
 */
...
public class GameScreen extends ScreenAdapter {
    ...
    private MyGdxGameJumpActionGame mGame;
    ...
    Sound sound1 = Gdx.audio.newSound(Gdx.files.internal("enemy.mp3"));
    Sound sound2 = Gdx.audio.newSound(Gdx.files.internal("game_clear.mp3"));


    public GameScreen(MyGdxGameJumpActionGame game) {
        mGame = game;
        ...
        mPrefs = Gdx.app.getPreferences("jp.techacademy.yuka.hongou.jumpactiongame");
    ...
    private void createStage() {
        ...
        mUfo.setPosition(WORLD_WIDTH / 2 - Ufo.UFO_HEIGHT / 2, y);
    }
