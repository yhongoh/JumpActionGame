...
public class Player extends GameObject {
    ...
    public static final float PLAYER_FALL_VELOCITY = 20.0f;

    int mState;

    public Player(Texture texture, int scrX, int scrY, int scrWidth, int scrHeight){
    ...
    public void update(float delta, float accelX) {
        ...
        velocity.x = -accelX /10 * PLAYER_FALL_VELOCITY;
