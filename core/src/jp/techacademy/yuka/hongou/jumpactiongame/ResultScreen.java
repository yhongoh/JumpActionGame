...
import static jp.techacademy.yuka.hongou.jumpactiongame.GameScreen.GAME_STATE_CLEAR;
...
public class ResultScreen extends ScreenAdapter {
    ...
    public ResultScreen(MyGdxGameJumpActionGame game, int score, int gameState) {
    ...
    public void render(float delta) {
        ...
        mFont.draw(mGame.batch, "Score: " + mScore, 0, GUI_HEIGHT / 2, GUI_WIDTH, Align.center, false);
